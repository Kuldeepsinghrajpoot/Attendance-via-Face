        ...
        <div className=' text-[#9C9AA6]   sticky top-0 z-50 flex justify-between  overflow-hidden shadow-md'>
            <div className=' flex justify-between w-full '>
                <div className='  hidden xl:block w-80 h-screen text-foreground bg-background'>
                    <div>
                        <div className='  px-4 gap-5 my-5 w-full h-full flex justify-center items-center text-center'>
                            <div className='w-10 h-10 flex justify-center items-center text-center'>
                                <img className=' w-full h-full bg-red-900  rounded-full ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN1NAnlhSMbhwPtdLoWbm4WkAQu5qpPH_Hzw&usqp=CAU" alt="typing speed" />
                            </div>
